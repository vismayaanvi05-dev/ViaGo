  ...
  const menuSections = [
    {
      ...
      items: [
        ...
        { icon: 'car-outline' as const, title: 'Vehicle Details', onPress: () => showToast('Coming soon') },
        { icon: 'document-text-outline' as const, title: 'Documents', onPress: () => showToast('Coming soon') },
        { icon: 'card-outline' as const, title: 'Bank Details', onPress: () => showToast('Coming soon') },
      ],
    },
    {
      title: 'Settings',
    ...
    },
    {
      title: 'Support',
      items: [
        { icon: 'help-circle-outline' as const, title: 'Help & Support', onPress: () => showToast('Coming soon') },
      ...
      <Modal visible={showEditProfile} transparent animationType="fade">
        <View style={styles.overlay}>
          <View style={styles.editModal}>
            ...
            <TouchableOpacity
              style={[styles.saveBtn, { backgroundColor: DRIVER_COLOR }]}
...
const styles = StyleSheet.create({
  ...
  roleBadge: {
    ...
    backgroundColor: '#D1FAE5', paddingHorizontal: 14, paddingVertical: 6,
    borderRadius: 20, gap: 6, marginTop: 8, marginBottom: 24,
  },
